...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="#" class="current">travelevent</a> </div>
  <h1>travelevent</h1>
</div>
...
$qry = "insert into travelevents(message,date) values ('$message','$date')";
