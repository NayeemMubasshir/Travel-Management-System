    ...
    <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-pencil"></i> </span>
            <h5>Update FAQ and Supps</h5>
          </div>
   
          <div class="widget-content nopadding">
            <form id="form-wizard" class="form-horizontal" action="actions/modifiedfaqandsupp" method="POST">
              <div id="form-wizard-1" class="step">
              <?php
      include 'setconntotraveldb.php';
      $id=$_GET['id'];
      $qry= "select * from faqandsupp where id='$id'";
