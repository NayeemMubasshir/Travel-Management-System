      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content">
            <div class="row-fluid">
              <div class="span4">
                <table class="">
                  <tbody>
                    <tr>
                      <td><h4>Nayeem Travelling Co.</h4></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td >Email: nayeemtravels@gmail.com</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div class="row-fluid">
                <div class="pull-left">
                <h4>Dear Member <?php echo $row['fullname']; ?>,<br/> <br/>Your travelpackage is currently <?php echo $row['status']; ?>! <br/></h4><p>Thank you for choosing our services.</p>
                </div>
                <div class="pull-right">
                  
                  <img src="../img/report/travellogo.png" width="124px;" alt=""></div>
