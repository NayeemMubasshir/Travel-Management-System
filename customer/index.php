...
<head>
    ...
    <div id="loginbox">            
            ...
            <div class="control-group normal_text"> <h3><img src="img/travelhead.png" alt="Logo" /></h3></div>
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lb"><i class="icon-user"> </i></span><input type="text" name="user" placeholder="Username" />
                        </div>
                    </div>
                </div>
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lb"><i class="icon-key"></i></span><input type="password" name="pass" placeholder="Password" />
                        </div>
                    </div>
                </div>
            ...
            <form id="recoverform" action="../customer/pages/register-cust.php" method="POST" class="form-vertical">
				<p class="normal_text">Enter your details below for activating account</p>
			

                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lb"><i class="icon-tag"></i></span><input type="text" name="fullname" placeholder="Fullname" />
                        </div>
                    </div>
                    ...
                    <br>
                        ...
                        <div class="controls">
                            <div class="main_input_box">
                                <span class="add-on bg_lb"><i class="icon-tag"></i></span><input type="text" name="username" placeholder="@username" />
                            </div>
                        </div>
                    ...
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lb"><i class="icon-tag"></i></span><input type="password" name="password" placeholder="Password" />
                        </div>
                    </div>
                ...
                <br>
                       ...
                       <div class="controls">
                            <div class="main_input_box">
                                <span class="add-on bg_lb"><i class="icon-tag"></i></span><input type="number" name="contact" placeholder="7878787878" />
                            </div>
                        </div>
                    ...
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lb"><i class="icon-tag"></i></span><input type="text" name="address" placeholder="Address" />
                        </div>
                    </div>
