...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">Nayeem Travelling Co</a></h1>
</div>
<!--close-Header-part--> 
            ...
            <div class="row-fluid">
              <div class="span5">
                <table class="">
                  <tbody>
                  <tr>
                      <td><img src="../img/travel-logo.png" alt="travel Logo" width="175"></td>
                    </tr>
                    <tr>
                      <td><h4>Nayeem Travelling Co Club</h4></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td >Email: support@nayeemtravellingco.com</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div class="span7">
                <table class="table table-bordered table-invoice">
				  ...
				  <form action="userpay.php" method="POST">
                    ...
                    <tr>
                      ...
                      <td><input id="amount" type="number" name="amount" value='<?php if($row['services'] == 'CoxBazar') { echo '55';} elseif ($row['services'] == 'Sylhet') { echo '35';} else {echo '40';} ?>' /></td>
                    </tr>
                ...
                <select name="plan" required="required" id="select">
                  <option value="1" selected="selected" >One Week</option>
